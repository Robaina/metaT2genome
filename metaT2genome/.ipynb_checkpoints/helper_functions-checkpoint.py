...
def deleteTemporaryFiles(None) -> None:
    """
    Remove temporary SAM files from directory
    """

def has_bwa_index(fasta_file: str, Optional[work_dir]=None) -> bool:
    """
...
def bwaAlign(fasta_file: str, fastq_1_file: str, Optional[fastq_2_file]=None, 
             Optional[n_threads]=1, Optional[output_dir]=None, 
             Optional[additional_params]=None) -> None:
    """
...
def sortSAMbyName(sam_file: str, Optional[output_dir]=None) -> None:
    """
